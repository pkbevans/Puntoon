...
-- Table `puntoon`.`users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `puntoon`.`users` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `puntoon`.`tournaments` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `puntoon`.`fixtures` ;
...
-- Table `puntoon`.`teams`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `puntoon`.`teams` ;
...
-- -----------------------------------------------------
-- Table `puntoon`.`competitions`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `puntoon`.`competitions` ;

CREATE TABLE IF NOT EXISTS `puntoon`.`competitions` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `tournament_id` INT NOT NULL,
  `name` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `puntoon`.`entries` ;
...
CREATE TABLE IF NOT EXISTS `puntoon`.`entries` (
  ...
  CONSTRAINT `COMPETITION`
    ...
    REFERENCES `puntoon`.`competitions` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `puntoon`.`statuses` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `puntoon`.`teams_tournaments` ;
...
USE `puntoon`$$
DROP TRIGGER IF EXISTS `puntoon`.`upd_goals` $$
USE `puntoon`$$
